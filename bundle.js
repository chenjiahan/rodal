	...
	var App = (function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var buttons = ['zoom', 'fade', 'slideDown'].map((function (value, index) {
