	...
	var App = (function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var types = ['zoom', 'fade', 'flip', 'slideUp', 'slideDown', 'slideLeft', 'slideRight'];
	            var buttons = types.map(function (value, index) {
	                ...
	                return _react2['default'].createElement(
	                    'button',
	                    { key: index, className: 'btn', onClick: _this2.show.bind(_this2, value), style: style },
	                    value
	                );
	            });
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'wrap', style: wrapStyle },
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'container' },
	                        _react2['default'].createElement(
